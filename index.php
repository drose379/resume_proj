...
$Resume = new Resume (array (
	...
	"Education" => array('YearsOfAttendance' => '2010-2014' , 'Activities' => array('Hockey','Lacrosse','Student Council')),
	"FurtherEducation" => array("College" => "University of Miami", "Major" => "Comp Sci", "Degree" => "Masters"),
